...
local NotiFrame = Instance.new("Frame")
	...
	DiscordLib:Notification("Thông Báo" , "Nhận Cày Thuê Bán Acc v4 Ae Nào Cần IB" , 6 ,16771492968 )
	DiscordLib:Notification("Thông Báo" , "Link Facebook Ở Phần Setting  1" , 6 ,16771492968 )
...
--------------------------
local Main = Library:Tab("Main","rbxassetid://16771492968")
local Weapon = Library:Tab("Weapons","rbxassetid://16771492968")
local ca = Library:Tab("Sea Events","http://www.roblox.com/asset/?id=16771492968")
local Race = Library:Tab("Race V4","rbxassetid://16771492968")
--local Stats = Library:Tab("Stats","rbxassetid://16771492968")
local P = Library:Tab("Player","rbxassetid://16771492968")
local Teleport = Library:Tab("Teleport","rbxassetid://16771492968")
local Dungeon = Library:Tab("Dungeon","rbxassetid://16771492968")
local DevilFruit = Library:Tab("Fruit+Esp","rbxassetid://16771492968")
local Shop = Library:Tab("Shop","rbxassetid://16771492968")
local Misc = Library:Tab("Misc","rbxassetid://16771492968")
--local Op = Library:Tab("Status", "rbxassetid://16771492968")
local Setting = Library:Tab("Settings","rbxassetid://16771492968")
--------------------------------------------------------------------
...
Setting:Button("Sao Chép Link Zalo Cày Thuê",function()
 
 setclipboard("https://zalo.me/g/ucukan565")
  DiscordLib:Notification("Thông Báo" , "Đã Sao Chép Link Facebook" , 10 ,16771492968 )
 end)
 ...
 game:GetService("RunService"):Set3dRenderingEnabled(true)
   ...
   Setting:Button("Giảm Lag",function()
	...
	function DiscordLib:Notification(text,text2,delays,logo)
      ...
      DiscordLib:Notification("Thông Báo" , "Bật Xong Sẽ Bị Đứng Máy 5-10 Giây" , 10 ,16771492968 )
      wait(3)
...
game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer(unpack(args))
DiscordLib:Notification("Thông Báo" , "Hoàn Tất" , 10 ,16771492968 )
end)
...
DiscordLib:Notification("Thông Báo" , "Nhân Phẩm Đã Lên 1000%" , 10 ,16771492968 )
  end)
...
DiscordLib:Notification("Thông Báo" , "Chào Bạn, Mình Là Admin Bản Duy Mod Game" , 6 ,16771492968)
    DiscordLib:Notification("Thông Báo" , "Cảm Ơn Bạn Đã Sử Dụng Duy Mod Game" , 8,16771492968)
            DiscordLib:Notification("Thông Báo" , "Chúc Bạn Có Nhiều Sức Khỏe" , 9 ,16771492968) 
DiscordLib:Notification("Thông Báo" , "Năm Mới Vui Vẻ Và Hạnh Phúc" , 13 ,16771492968)
end